...
INPUT_FILE = BASE_DIR / "02_B_chunked" / "chunks_semantic_pdf.jsonl"
OUTPUT_DIR = BASE_DIR / "03_B_embedded"
OUTPUT_FILE = OUTPUT_DIR / "embeddings_semantic_pdf.jsonl"
CHECKPOINT_FILE = OUTPUT_DIR / "checkpoint_semantic_pdf.json"
...
# 로깅 설정
logging.basicConfig(
    filename=OUTPUT_DIR / 'embedding_semantic_pdf_errors.log',
    level=logging.ERROR,
...
def main():
    ...
    """
    print("=" * 80)
    print("PDF 데이터 임베딩 생성 시작 (의미 기반 청킹)")
    print("=" * 80)
    ...
    metadata_file = OUTPUT_DIR / "metadata_semantic_pdf.json"
    ...
    print("\n" + "=" * 80)
    print("[OK] PDF 데이터 임베딩 완료! (의미 기반 청킹)")
    print("=" * 80)
