...
CASE_TITLES = {
    '1': '무료체험 권유 후 대금 청구하는 건강기능식품의 반품 요구',
    '2': '백내장 수술 후 시력저하 등 문제 발생에 따른 손해배상 요구',
    '3': '요양병원 입원 중 왕자의 사고 발생에 따른 손해배상 요구',
    '4': '소음 발생하는 보청기 구입가 환급 요구',
    '5': '부가상품 제공을 이유로 거절된 상조계약의 해지환급금 지급 요구',
    '6': '적정한 수술에 대한 실손보험금 지급 요구',
    '7': '폐암 오진으로 인한 수술에 따른 손해배상 요구',
    '8': '유사투자자문 서비스 계약취소에 따른 대금 환급 요구',
    '9': '이동전화 해지 누락으로 발생한 부당요금 청구 환급 요구',
    '10': '임플란트 시술 후 문제 발생에 따른 손해배상 요구',
    '11': '수술 후 물리치료 중 발생한 골절에 따른 손해배상 요구',
    '12': '치아 치료 후 재치료가 필요한 데 따른 손해배상 요구',
}
...
def main():
    pdf_path = r"C:\Users\Playdata\Desktop\project\05_5th_project\data_n_db\B_case\01_B_parsed\02_02_AdjustmentCase\01_kca\고령층을 위한 분쟁조정 사례집.pdf"
    output_dir = r"C:\Users\Playdata\Desktop\project\05_5th_project\data_n_db\B_case\01_B_parsed\02_02_AdjustmentCase\01_kca"
    output_file = Path(output_dir) / "고령층을 위한 분쟁조정 사례집.json"
