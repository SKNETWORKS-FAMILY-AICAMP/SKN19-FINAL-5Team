...
# scripts/preprocess/metadata/prune_metadata_115.py
...
IN_PATH = (
    ...
    / "dmge_rlif"
    / "processed"
    / "dmge_rlif_cases_115_full.processed.clean.jsonl"
)
...
OUT_PATH = (
    ...
    / "dmge_rlif"
    / "processed"
    / "dmge_rlif_cases_115_full.processed.clean.pruned.jsonl"
)

# ✅ 115 피해구제 사례 metadata에서 제거할 키들
DROP_KEYS = {
    "site",
    "source_list",
    "doc_type_std",
