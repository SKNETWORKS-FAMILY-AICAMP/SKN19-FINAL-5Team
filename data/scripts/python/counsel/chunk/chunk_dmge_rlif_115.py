# scripts/preprocess/chunk/chunk_dmge_rlif_115.py
"""
dmge_rlif (dmge_rlif_case) 데이터셋 청킹 스크립트
...
# 입력/출력 경로
IN_PATH = BASE_DIR / "data" / "dmge_rlif" / "dmge_rlif_cases_115_full.jsonl"
OUT_DIR = BASE_DIR / "data" / "dmge_rlif" / "chunks"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_PATH = OUT_DIR / "dmge_rlif_cases_115_chunks.jsonl"
...
def chunk_document(doc: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    doc_type = metadata.get("doc_type", "dmge_rlif_case")
    dataset = "dmge_rlif"
