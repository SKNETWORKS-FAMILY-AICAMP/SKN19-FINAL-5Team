# scripts/preprocess/chunk/chunk_cnslt_114.py
"""
cnslt (consumer_counsel_case) 데이터셋 청킹 스크립트
...
# 입력/출력 경로
IN_PATH = BASE_DIR / "data" / "cnslt" / "cnslt_cases_114_full.jsonl"
OUT_DIR = BASE_DIR / "data" / "cnslt" / "chunks"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_PATH = OUT_DIR / "cnslt_cases_114_chunks.jsonl"
...
def chunk_document(doc: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    doc_type = metadata.get("doc_type", "consumer_counsel_case")
    dataset = "cnslt"
